...
function App() {
  ...
  return (
    ...
    <Banner 
      id='home' 
      imageBanner={`url(${imageBanner})`}>
      <TitleTyping 
        arrMessages={textTitle}
      />
    </Banner>
    ...
    <Section 
      id='section2' 
      styles={{
        display: 'grid', 'grid-template-columns': '1fr 1fr 1fr 1fr', 'grid-template-rows': '1fr', 'align-items': "center", 
        transform: 'scale(1.1)', 
        height: '100vh', 'min-height': '80vh', 
        width: '80vw'
      }} 
      imageSection={`url(${imgSection2})`}>
      <ImgSection 
        styles={{
          height: '100vh', 
          width: '20%', 'grid-column': '2/3', 'justify-self':'flex-end'
        }} 
      ...
      <Paragrafo 
        styles={{
          'grid-column': '3/5', 
          color: '#000', 
          'font-size': 'clamp(1rem, 1vw, 2rem)', 'text-shadow': '1px 1px 2px black', 
    ...
    <Section 
      ...
      imageSection={`url(${backgroundAmarelo})`}>
      <ImgSection 
        styles={{
          position: 'absolute', 
          right: 0, 
    ...
    <Section 
      ...
      <Paragrafo 
        styles={{
          ...
          color: '#000', 
          'font-weight': 'bold', 
          'font-size': 'clamp(.8rem, 1vw, 1.8rem)', width: '96%', 
          'text-align': 'center', 
